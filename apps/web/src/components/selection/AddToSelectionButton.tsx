...
export function AddToSelectionButton({ item, className = "" }: AddToSelectionButtonProps) {
  ...
  return (
    <button
      ...
      className={`min-h-[44px] text-[10px] font-medium uppercase tracking-[0.12em] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-stone-900 focus-visible:ring-offset-2 disabled:cursor-default ${
        selected
          ? "text-stone-400"
          : feedback === "full"
            ? "text-amber-700"

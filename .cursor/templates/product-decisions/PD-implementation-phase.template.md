<!--
  ...
  Location: .cursor/templates/product-decisions/PD-implementation-phase.template.md
...
(`.cursor/rules/execution-loop.mdc` §11–§12, PD-001). The product workflow is now

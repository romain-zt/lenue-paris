...
Drives `/intake`. Read first: `.cursor/rules/intake-flow.mdc`,
`.cursor/checkers/setup-readiness-checker.md`, `.cursor/rules/00-siso.mdc`,
`.cursor/rules/20-model-routing.mdc`.

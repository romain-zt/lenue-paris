...
Before executing `propose`, `scaffold`, `refine`, `check`, or `promote`, confirm that a User Story Context Brief has been produced by the User Story Lead (`.cursor/agents/user-story/user-story-lead.md`) for this command flow.
...
6. Invoke Story Critic (`.cursor/agents/user-story/story-critic.md`) to review the proposal before presenting.
7. Present using the output format in `.cursor/commands/user-story.md` Mode: propose.
...
Materialize an **approved** User Story proposal into files. Governed by `.cursor/commands/user-story.md` Mode: scaffold.
...
3. If missing or empty-only: instantiate from `.cursor/templates/product/user-story.template.md`.
...
Edit product-level sections of one User Story. Governed by `.cursor/commands/user-story.md` Mode: refine.
...
Run Part 4 (US-01..US-N) + CC-01..CC-05 from `.cursor/checkers/scope-readiness-checker.md` against one User Story file.
...
Apply the narrow **ready-for-spec** transition after CLEAR. Governed by `.cursor/commands/user-story.md` Mode: promote.

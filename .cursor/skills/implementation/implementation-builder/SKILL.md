...
Operational skill for `/implement`. Read first: `.cursor/rules/implementation-workflow.mdc`.
Align with `.cursor/rules/30-test-strategy.mdc`, `.cursor/rules/40-architecture-baseline.mdc`, `.cursor/rules/20-model-routing.mdc`.

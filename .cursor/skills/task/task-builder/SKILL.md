...
Use the output format in `.cursor/commands/task.md` Mode: propose.

## 4. Mode: scaffold

Materialize an **approved** Task proposal into files. Governed by `.cursor/commands/task.md` Mode: scaffold.
...
3. Else instantiate from `.cursor/templates/product/task.template.md`.
...
Edit implementation sections of one Task. Governed by `.cursor/commands/task.md` Mode: refine.

...
`.cursor/rules/40-architecture-baseline.mdc`. This is **Vision-tier** work
(`claude-opus-4-8`) — see `.cursor/rules/20-model-routing.mdc`.
...
Use `.cursor/templates/prd/product-decision.template.md`. Keep it: context → decision → consequences.

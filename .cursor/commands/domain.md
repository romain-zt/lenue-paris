...
|------|-------|-------|------|
| `architecture` | `.cursor/skills/domains/architecture/SKILL.md` | `architecture-specialist` | Vision (`claude-opus-4-8`) |
| `backend` | `.cursor/skills/domains/backend/SKILL.md` | `backend-specialist` | Manager (`claude-4.6-sonnet`) |
| `http` | `.cursor/skills/domains/http/SKILL.md` | `http-specialist` | Manager |
| `event` | `.cursor/skills/domains/event/SKILL.md` | `event-specialist` | Manager |
| `websocket` | `.cursor/skills/domains/websocket/SKILL.md` | `websocket-specialist` | Manager |
| `design` | `.cursor/skills/domains/design/SKILL.md` | `design-specialist` | Manager |
| `copywriter` | `.cursor/skills/domains/copywriter/SKILL.md` | `copywriter-specialist` | Manager |
| `marketing` | `.cursor/skills/domains/marketing/SKILL.md` | `marketing-specialist` | Manager |
| `business` | `.cursor/skills/domains/business/SKILL.md` | `business-specialist` | Vision (`claude-opus-4-8`) |

## Behavior

1. Resolve `<name>` to a row above. If unknown, list the domains and stop.
2. Load that domain's **skill** and adopt its doctrine.
3. Run as the matching **agent** at its model tier (`.cursor/rules/20-model-routing.mdc`). For a heavy/parallel task, delegate to the specialist as a subagent.

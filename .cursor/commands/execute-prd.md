...
Also respect: `.cursor/rules/feature-area-workflow.mdc`, `.cursor/rules/user-story-workflow.mdc`, `.cursor/commands/feature-area.md`, `.cursor/commands/user-story.md`, `.cursor/commands/spec.md`, `.cursor/commands/task.md`, `.cursor/checkers/scope-readiness-checker.md`, `docs/product-decisions/PD-001-post-slice-workflow.md`, `docs/product-decisions/PD-006-per-fa-delivery-readiness-gate.md`, `.cursor/rules/00-siso.mdc`.

...
Governed by: `.cursor/rules/implementation-workflow.mdc`
Doctrine: `.cursor/rules/30-test-strategy.mdc`, `.cursor/rules/40-architecture-baseline.mdc`, `.cursor/rules/20-model-routing.mdc`
Skill: `.cursor/skills/implementation/implementation-builder/SKILL.md`
Agents: `.cursor/agents/implementation/{implementation-lead,executor,implementation-reviewer}.md`

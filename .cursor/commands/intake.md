...
Skill: `.cursor/skills/intake/intake-router/SKILL.md`
Agent: `.cursor/agents/intake/intake-router.md` (Vision tier)
Checker: `.cursor/checkers/setup-readiness-checker.md`

...
- **Implementation governance enabled:** yes — authorized by `docs/product-decisions/PD-007-implementation-phase.md` (approved 2026-06-14)
...
This is the single kill-switch for unattended PRD → decomposition → implementation. It is
the explicit SISO waiver (`00-siso.mdc`) and the human-approval substitute that the
`/feature-area` and `/prd` workflows require before writing product scope without a human
in the conversation.

- **Autonomous decomposition enabled:** yes — authorized by `docs/product-decisions/PD-008-autonomous-decomposition.md` (approved 2026-06-14)

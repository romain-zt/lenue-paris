 ...
 *
 * Project-agnostic — the agent reads docs/project.config.md + .cursor/core/rules/ in-run.
 */
...
- Relevant \`.cursor/core/rules/\` only if the fix risks crossing a governance boundary.

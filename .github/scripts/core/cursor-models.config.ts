 ...
 *     `tsx .github/scripts/core/discover-cursor-models.ts`) with `CURSOR_API_KEY`
...
/**
 * Per-script model-tier assignment, aligned with .cursor/core/rules/20-model-routing.mdc.

 ...
 *
 *   CURSOR_API_KEY=... npx tsx .github/scripts/discover-cursor-models.ts
 *
 ...
 *   - sanity-check that the doctrine in `.cursor/rules/20-model-routing.mdc`
...
async function main(): Promise<void> {
  ...
  console.log("");
  console.log("Tier id candidates (per .cursor/rules/20-model-routing.mdc):");
